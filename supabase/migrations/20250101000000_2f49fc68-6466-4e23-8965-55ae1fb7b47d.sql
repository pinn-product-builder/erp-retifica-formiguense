...
-- 4. Add org_id to business tables (moved to later migration after all tables are created)
-- These ALTER TABLE statements will be applied in migration 20250102000000
...
-- Indexes for org_id will be created after the columns are added in a later migration

-- 6. Create update_updated_at function if not exists
