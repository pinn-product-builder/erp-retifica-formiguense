-- Migration: Public Schema - All Tables
-- Description: Creates all tables, indexes, and triggers in the public schema
-- Based on: backup/public-ddl.sql
-- Generated from DDL backup
...
CREATE INDEX IF NOT EXISTS idx_achievement_configs_active ON public.achievement_configs USING btree (is_active);
CREATE INDEX IF NOT EXISTS idx_achievement_configs_org ON public.achievement_configs USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_alerts_purchase_need_metadata ON public.alerts USING gin (metadata) WHERE (alert_type = 'purchase_need'::text);
...
CREATE INDEX IF NOT EXISTS idx_notifications_org_global_unread ON public.notifications USING btree (org_id, is_global, is_read, created_at DESC) WHERE ((is_global = true) AND (is_read = false));
...
CREATE INDEX IF NOT EXISTS idx_accounts_payable_org_id ON public.accounts_payable USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_accounts_receivable_budget_id ON public.accounts_receivable USING btree (budget_id) WHERE (budget_id IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_accounts_receivable_org_id ON public.accounts_receivable USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_alert_history_alert_id ON public.alert_history USING btree (alert_id);
CREATE INDEX IF NOT EXISTS idx_alert_history_created_at ON public.alert_history USING btree (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_alert_history_org_id ON public.alert_history USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_alert_history_severity ON public.alert_history USING btree (severity);
...
CREATE INDEX IF NOT EXISTS idx_approval_rules_active ON public.approval_rules USING btree (is_active) WHERE (is_active = true);
CREATE INDEX IF NOT EXISTS idx_approval_rules_org_id ON public.approval_rules USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_approval_rules_type ON public.approval_rules USING btree (rule_type);
...
CREATE INDEX IF NOT EXISTS idx_approval_workflows_approved_by ON public.approval_workflows USING btree (approved_by) WHERE (approved_by IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_approval_workflows_org_id ON public.approval_workflows USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_approval_workflows_reference ON public.approval_workflows USING btree (reference_id, reference_table);
CREATE INDEX IF NOT EXISTS idx_approval_workflows_requested_by ON public.approval_workflows USING btree (requested_by);
CREATE INDEX IF NOT EXISTS idx_approval_workflows_status ON public.approval_workflows USING btree (status);
CREATE INDEX IF NOT EXISTS idx_approval_workflows_type ON public.approval_workflows USING btree (workflow_type);
...
CREATE INDEX IF NOT EXISTS idx_budget_alerts_active ON public.budget_alerts USING btree (is_active);
CREATE INDEX IF NOT EXISTS idx_budget_alerts_budget ON public.budget_alerts USING btree (budget_id);
CREATE INDEX IF NOT EXISTS idx_budget_alerts_type ON public.budget_alerts USING btree (alert_type);
...
CREATE INDEX IF NOT EXISTS idx_budget_approvals_budget ON public.budget_approvals USING btree (budget_id);
CREATE INDEX IF NOT EXISTS idx_budget_approvals_date ON public.budget_approvals USING btree (approved_at);
CREATE INDEX IF NOT EXISTS idx_budget_approvals_org_budget ON public.budget_approvals USING btree (org_id, budget_id);
CREATE INDEX IF NOT EXISTS idx_budget_approvals_org_id ON public.budget_approvals USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_budget_approvals_type ON public.budget_approvals USING btree (approval_type);
...
CREATE INDEX IF NOT EXISTS idx_company_fiscal_settings_org_id ON public.company_fiscal_settings USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_detailed_budgets_budget_number_pattern ON public.detailed_budgets USING btree (budget_number) WHERE (budget_number IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_detailed_budgets_component ON public.detailed_budgets USING btree (component);
CREATE INDEX IF NOT EXISTS idx_detailed_budgets_number ON public.detailed_budgets USING btree (budget_number);
CREATE INDEX IF NOT EXISTS idx_detailed_budgets_order ON public.detailed_budgets USING btree (order_id);
CREATE INDEX IF NOT EXISTS idx_detailed_budgets_org_budget ON public.detailed_budgets USING btree (org_id, budget_number) WHERE (budget_number IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_detailed_budgets_org_id ON public.detailed_budgets USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_detailed_budgets_org_order ON public.detailed_budgets USING btree (org_id, order_id);
CREATE INDEX IF NOT EXISTS idx_detailed_budgets_status ON public.detailed_budgets USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_diagnostic_checklist_items_checklist ON public.diagnostic_checklist_items USING btree (checklist_id);
CREATE INDEX IF NOT EXISTS idx_diagnostic_checklist_items_order ON public.diagnostic_checklist_items USING btree (display_order);
...
CREATE INDEX IF NOT EXISTS idx_diagnostic_checklist_responses_org_id ON public.diagnostic_checklist_responses USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_diagnostic_responses_component ON public.diagnostic_checklist_responses USING btree (component);
CREATE INDEX IF NOT EXISTS idx_diagnostic_responses_diagnosed_by ON public.diagnostic_checklist_responses USING btree (diagnosed_by);
CREATE INDEX IF NOT EXISTS idx_diagnostic_responses_order ON public.diagnostic_checklist_responses USING btree (order_id);
...
CREATE INDEX IF NOT EXISTS idx_diagnostic_checklists_component ON public.diagnostic_checklists USING btree (component);
CREATE INDEX IF NOT EXISTS idx_diagnostic_checklists_engine_type ON public.diagnostic_checklists USING btree (engine_type_id);
CREATE INDEX IF NOT EXISTS idx_diagnostic_checklists_org ON public.diagnostic_checklists USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_engine_types_category ON public.engine_types USING btree (category);
CREATE INDEX IF NOT EXISTS idx_engine_types_org ON public.engine_types USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_engines_org_id ON public.engines USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_form_submissions_date ON public.entry_form_submissions USING btree (submitted_at);
CREATE INDEX IF NOT EXISTS idx_form_submissions_order ON public.entry_form_submissions USING btree (order_id);
CREATE INDEX IF NOT EXISTS idx_form_submissions_template ON public.entry_form_submissions USING btree (template_id);
...
CREATE INDEX IF NOT EXISTS idx_fiscal_classifications_org_id ON public.fiscal_classifications USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_inventory_count_items_part_id ON public.inventory_count_items USING btree (part_id);
...
CREATE INDEX IF NOT EXISTS idx_inventory_counts_count_date ON public.inventory_counts USING btree (count_date DESC);
CREATE INDEX IF NOT EXISTS idx_inventory_counts_org_id ON public.inventory_counts USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_inventory_counts_status ON public.inventory_counts USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_inventory_movements_budget_id ON public.inventory_movements USING btree (budget_id) WHERE (budget_id IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_inventory_movements_created_at ON public.inventory_movements USING btree (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_inventory_movements_order_id ON public.inventory_movements USING btree (order_id) WHERE (order_id IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_inventory_movements_org_id ON public.inventory_movements USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_inventory_movements_part_id ON public.inventory_movements USING btree (part_id);
...
CREATE INDEX IF NOT EXISTS idx_kpi_targets_goal_type ON public.kpi_targets USING btree (goal_type);
CREATE INDEX IF NOT EXISTS idx_kpi_targets_org_id ON public.kpi_targets USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_kpi_targets_parent_goal ON public.kpi_targets USING btree (parent_goal_id);
CREATE INDEX IF NOT EXISTS idx_kpi_targets_priority ON public.kpi_targets USING btree (priority);
CREATE INDEX IF NOT EXISTS idx_kpi_targets_status ON public.kpi_targets USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_obligation_files_obligation ON public.obligation_files USING btree (obligation_id);
CREATE INDEX IF NOT EXISTS obligation_files_generated_at_idx ON public.obligation_files USING btree (generated_at);
CREATE INDEX IF NOT EXISTS obligation_files_obligation_id_idx ON public.obligation_files USING btree (obligation_id);
...
CREATE INDEX IF NOT EXISTS idx_obligation_kinds_org_id ON public.obligation_kinds USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_obligations_created_by ON public.obligations USING btree (created_by);
CREATE INDEX IF NOT EXISTS idx_obligations_kind_period ON public.obligations USING btree (obligation_kind_id, period_year, period_month);
CREATE INDEX IF NOT EXISTS idx_obligations_org_id ON public.obligations USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_obligations_period ON public.obligations USING btree (period_year, period_month);
...
CREATE INDEX IF NOT EXISTS idx_order_warranties_order ON public.order_warranties USING btree (order_id, is_active);
...
CREATE INDEX IF NOT EXISTS idx_order_workflow_status_pending ON public.order_workflow USING btree (status, component) WHERE ((started_at IS NOT NULL) AND (completed_at IS NULL));
...
CREATE INDEX IF NOT EXISTS idx_orders_org_created_by ON public.orders USING btree (org_id, created_by);
CREATE INDEX IF NOT EXISTS idx_orders_org_id ON public.orders USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_orders_status_created_by ON public.orders USING btree (status, created_by) WHERE (created_by IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_org_users_org_id ON public.organization_users USING btree (organization_id);
CREATE INDEX IF NOT EXISTS idx_org_users_role ON public.organization_users USING btree (role);
CREATE INDEX IF NOT EXISTS idx_org_users_user_id ON public.organization_users USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_organizations_is_active ON public.organizations USING btree (is_active);
...
CREATE INDEX IF NOT EXISTS idx_parts_inventory_org_component ON public.parts_inventory USING btree (org_id, component);
CREATE INDEX IF NOT EXISTS idx_parts_inventory_org_id ON public.parts_inventory USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_parts_inventory_org_status ON public.parts_inventory USING btree (org_id, status);
...
CREATE INDEX IF NOT EXISTS idx_parts_price_table_code ON public.parts_price_table USING btree (part_code);
CREATE INDEX IF NOT EXISTS idx_parts_price_table_org ON public.parts_price_table USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_parts_reservations_budget ON public.parts_reservations USING btree (budget_id);
CREATE INDEX IF NOT EXISTS idx_parts_reservations_budget_id ON public.parts_reservations USING btree (budget_id) WHERE (budget_id IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_parts_reservations_expires_at ON public.parts_reservations USING btree (expires_at) WHERE ((reservation_status)::text = ANY ((ARRAY['reserved'::character varying, 'partial'::character varying, 'separated'::character varying])::text[]));
CREATE INDEX IF NOT EXISTS idx_parts_reservations_order ON public.parts_reservations USING btree (order_id);
CREATE INDEX IF NOT EXISTS idx_parts_reservations_order_budget ON public.parts_reservations USING btree (order_id, budget_id);
CREATE INDEX IF NOT EXISTS idx_parts_reservations_org ON public.parts_reservations USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_parts_reservations_part_code ON public.parts_reservations USING btree (part_code);
CREATE INDEX IF NOT EXISTS idx_parts_reservations_part_id ON public.parts_reservations USING btree (part_id) WHERE (part_id IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_parts_reservations_status ON public.parts_reservations USING btree (reservation_status);
CREATE INDEX IF NOT EXISTS idx_parts_reservations_status_org ON public.parts_reservations USING btree (reservation_status, org_id);
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_reservation_per_budget_part ON public.parts_reservations USING btree (budget_id, part_code, order_id) WHERE ((budget_id IS NOT NULL) AND ((reservation_status)::text = ANY ((ARRAY['reserved'::character varying, 'partial'::character varying, 'separated'::character varying])::text[])));
...
CREATE INDEX IF NOT EXISTS idx_parts_stock_config_critical ON public.parts_stock_config USING btree (is_critical);
CREATE INDEX IF NOT EXISTS idx_parts_stock_config_org ON public.parts_stock_config USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_parts_stock_config_part ON public.parts_stock_config USING btree (part_code);
...
CREATE INDEX IF NOT EXISTS idx_performance_rankings_org_period ON public.performance_rankings USING btree (org_id, period_type, period_start);
CREATE INDEX IF NOT EXISTS idx_performance_rankings_rank ON public.performance_rankings USING btree (rank_position);
CREATE INDEX IF NOT EXISTS idx_performance_rankings_user ON public.performance_rankings USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_profile_page_permissions_page_id ON public.profile_page_permissions USING btree (page_id);
CREATE INDEX IF NOT EXISTS idx_profile_page_permissions_profile_id ON public.profile_page_permissions USING btree (profile_id);
...
CREATE INDEX IF NOT EXISTS idx_purchase_needs_org ON public.purchase_needs USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_purchase_needs_part_code ON public.purchase_needs USING btree (part_code);
CREATE INDEX IF NOT EXISTS idx_purchase_needs_priority ON public.purchase_needs USING btree (priority_level);
CREATE INDEX IF NOT EXISTS idx_purchase_needs_status ON public.purchase_needs USING btree (status);
CREATE INDEX IF NOT EXISTS idx_purchase_needs_urgency ON public.purchase_needs USING btree (delivery_urgency_date);
...
CREATE INDEX IF NOT EXISTS idx_purchase_order_items_part_id ON public.purchase_order_items USING btree (part_id) WHERE (part_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_purchase_receipt_items_part_id ON public.purchase_receipt_items USING btree (part_id) WHERE (part_id IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_purchase_receipt_items_po_item_id ON public.purchase_receipt_items USING btree (purchase_order_item_id);
CREATE INDEX IF NOT EXISTS idx_purchase_receipt_items_receipt_id ON public.purchase_receipt_items USING btree (receipt_id);
...
CREATE INDEX IF NOT EXISTS idx_purchase_receipts_date ON public.purchase_receipts USING btree (receipt_date DESC);
CREATE INDEX IF NOT EXISTS idx_purchase_receipts_org_id ON public.purchase_receipts USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_purchase_receipts_po_id ON public.purchase_receipts USING btree (purchase_order_id);
CREATE INDEX IF NOT EXISTS idx_purchase_receipts_status ON public.purchase_receipts USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_quality_history_component ON public.quality_history USING btree (component);
CREATE INDEX IF NOT EXISTS idx_quality_history_date ON public.quality_history USING btree (recorded_at);
CREATE INDEX IF NOT EXISTS idx_quality_history_event_type ON public.quality_history USING btree (quality_event_type);
CREATE INDEX IF NOT EXISTS idx_quality_history_order ON public.quality_history USING btree (order_id);
CREATE INDEX IF NOT EXISTS idx_quality_history_severity ON public.quality_history USING btree (severity_level);
...
CREATE INDEX IF NOT EXISTS idx_service_price_table_component ON public.service_price_table USING btree (component);
CREATE INDEX IF NOT EXISTS idx_service_price_table_engine_type ON public.service_price_table USING btree (engine_type_id);
CREATE INDEX IF NOT EXISTS idx_service_price_table_org ON public.service_price_table USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_status_config_engine_type ON public.status_config USING btree (engine_type_id);
...
CREATE INDEX IF NOT EXISTS idx_stock_alerts_active ON public.stock_alerts USING btree (is_active);
CREATE INDEX IF NOT EXISTS idx_stock_alerts_level ON public.stock_alerts USING btree (alert_level);
CREATE INDEX IF NOT EXISTS idx_stock_alerts_org ON public.stock_alerts USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_stock_alerts_org_part ON public.stock_alerts USING btree (org_id, part_code) WHERE ((part_code IS NOT NULL) AND (is_active = true));
CREATE INDEX IF NOT EXISTS idx_stock_alerts_part ON public.stock_alerts USING btree (part_code);
...
CREATE INDEX IF NOT EXISTS idx_supplier_contacts_is_primary ON public.supplier_contacts USING btree (is_primary) WHERE (is_primary = true);
CREATE INDEX IF NOT EXISTS idx_supplier_contacts_org_id ON public.supplier_contacts USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_supplier_evaluations_evaluated_at ON public.supplier_evaluations USING btree (evaluated_at DESC);
CREATE INDEX IF NOT EXISTS idx_supplier_evaluations_org_id ON public.supplier_evaluations USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_supplier_evaluations_po_id ON public.supplier_evaluations USING btree (purchase_order_id) WHERE (purchase_order_id IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_supplier_evaluations_supplier_id ON public.supplier_evaluations USING btree (supplier_id);
...
CREATE INDEX IF NOT EXISTS idx_supplier_performance_date ON public.supplier_performance_history USING btree (recorded_at);
CREATE INDEX IF NOT EXISTS idx_supplier_performance_part ON public.supplier_performance_history USING btree (part_code);
CREATE INDEX IF NOT EXISTS idx_supplier_performance_supplier ON public.supplier_performance_history USING btree (supplier_id);
...
CREATE INDEX IF NOT EXISTS idx_supplier_suggestions_need ON public.supplier_suggestions USING btree (purchase_need_id);
CREATE INDEX IF NOT EXISTS idx_supplier_suggestions_score ON public.supplier_suggestions USING btree (cost_benefit_score);
CREATE INDEX IF NOT EXISTS idx_supplier_suggestions_supplier ON public.supplier_suggestions USING btree (supplier_id);
...
CREATE INDEX IF NOT EXISTS idx_suppliers_brands ON public.suppliers USING gin (brands);
CREATE INDEX IF NOT EXISTS idx_suppliers_categories ON public.suppliers USING gin (categories);
CREATE INDEX IF NOT EXISTS idx_suppliers_is_preferred ON public.suppliers USING btree (is_preferred) WHERE (is_preferred = true);
...
CREATE INDEX IF NOT EXISTS idx_tax_calculations_order ON public.tax_calculations USING btree (order_id);
CREATE INDEX IF NOT EXISTS idx_tax_calculations_org_id ON public.tax_calculations USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_tax_calculations_regime ON public.tax_calculations USING btree (regime_id);
CREATE INDEX IF NOT EXISTS tax_calc_order_idx ON public.tax_calculations USING btree (order_id, calculated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_tax_ledgers_org_id ON public.tax_ledgers USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_tax_ledgers_period ON public.tax_ledgers USING btree (period_year, period_month);
CREATE INDEX IF NOT EXISTS idx_tax_ledgers_tax_type ON public.tax_ledgers USING btree (tax_type_id);
...
CREATE INDEX IF NOT EXISTS idx_tax_rate_tables_org_id ON public.tax_rate_tables USING btree (org_id);
CREATE INDEX IF NOT EXISTS tax_rate_idx ON public.tax_rate_tables USING btree (tax_type_id, jurisdiction_code, classification_id, valid_from);
...
CREATE INDEX IF NOT EXISTS idx_tax_regimes_org_id ON public.tax_regimes USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_tax_rules_org_id ON public.tax_rules USING btree (org_id);
CREATE INDEX IF NOT EXISTS tax_rules_query_idx ON public.tax_rules USING btree (regime_id, tax_type_id, operation, classification_id, origin_uf, destination_uf, is_active, valid_from);
...
CREATE INDEX IF NOT EXISTS idx_tax_types_org_id ON public.tax_types USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_technical_report_templates_org ON public.technical_report_templates USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_technical_report_templates_standard ON public.technical_report_templates USING btree (technical_standard);
CREATE INDEX IF NOT EXISTS idx_technical_report_templates_type ON public.technical_report_templates USING btree (report_type);
...
CREATE INDEX IF NOT EXISTS idx_technical_reports_component ON public.technical_reports USING btree (component);
CREATE INDEX IF NOT EXISTS idx_technical_reports_conformity ON public.technical_reports USING btree (conformity_status);
CREATE INDEX IF NOT EXISTS idx_technical_reports_number ON public.technical_reports USING btree (report_number);
CREATE INDEX IF NOT EXISTS idx_technical_reports_order ON public.technical_reports USING btree (order_id);
CREATE INDEX IF NOT EXISTS idx_technical_reports_type ON public.technical_reports USING btree (report_type);
...
CREATE INDEX IF NOT EXISTS idx_technical_standards_config_code ON public.technical_standards_config USING btree (standard_code);
CREATE INDEX IF NOT EXISTS idx_technical_standards_config_org ON public.technical_standards_config USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_user_achievements_earned_at ON public.user_achievements USING btree (earned_at);
CREATE INDEX IF NOT EXISTS idx_user_achievements_org_user ON public.user_achievements USING btree (org_id, user_id);
...
CREATE INDEX IF NOT EXISTS idx_user_basic_info_email ON public.user_basic_info USING btree (email);
CREATE INDEX IF NOT EXISTS idx_user_basic_info_user_id ON public.user_basic_info USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_user_profile_assignments_org_id ON public.user_profile_assignments USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_user_profile_assignments_profile_id ON public.user_profile_assignments USING btree (profile_id);
CREATE INDEX IF NOT EXISTS idx_user_profile_assignments_user_id ON public.user_profile_assignments USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_user_profiles_org_id ON public.user_profiles USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_user_profiles_sector_id ON public.user_profiles USING btree (sector_id);
...
CREATE INDEX IF NOT EXISTS idx_user_score_history_created_at ON public.user_score_history USING btree (created_at);
CREATE INDEX IF NOT EXISTS idx_user_score_history_org_user ON public.user_score_history USING btree (org_id, user_id);
...
CREATE INDEX IF NOT EXISTS idx_user_scores_level ON public.user_scores USING btree (current_level);
CREATE INDEX IF NOT EXISTS idx_user_scores_org_user ON public.user_scores USING btree (org_id, user_id);
CREATE INDEX IF NOT EXISTS idx_user_scores_points ON public.user_scores USING btree (total_points);
...
CREATE INDEX IF NOT EXISTS idx_user_sectors_org_id ON public.user_sectors USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_workflow_checklist_items_checklist ON public.workflow_checklist_items USING btree (checklist_id);
CREATE INDEX IF NOT EXISTS idx_workflow_checklist_items_critical ON public.workflow_checklist_items USING btree (is_critical);
CREATE INDEX IF NOT EXISTS idx_workflow_checklist_items_order ON public.workflow_checklist_items USING btree (display_order);
...
CREATE INDEX IF NOT EXISTS idx_workflow_checklist_responses_checklist ON public.workflow_checklist_responses USING btree (checklist_id);
CREATE INDEX IF NOT EXISTS idx_workflow_checklist_responses_component ON public.workflow_checklist_responses USING btree (component);
CREATE INDEX IF NOT EXISTS idx_workflow_checklist_responses_order ON public.workflow_checklist_responses USING btree (order_id);
CREATE INDEX IF NOT EXISTS idx_workflow_checklist_responses_order_workflow ON public.workflow_checklist_responses USING btree (order_workflow_id);
CREATE INDEX IF NOT EXISTS idx_workflow_checklist_responses_status ON public.workflow_checklist_responses USING btree (overall_status);
CREATE INDEX IF NOT EXISTS idx_workflow_responses_workflow_checklist ON public.workflow_checklist_responses USING btree (order_workflow_id, checklist_id, overall_status);
...
CREATE INDEX IF NOT EXISTS idx_workflow_checklists_component ON public.workflow_checklists USING btree (component);
CREATE INDEX IF NOT EXISTS idx_workflow_checklists_engine_type ON public.workflow_checklists USING btree (engine_type_id);
CREATE INDEX IF NOT EXISTS idx_workflow_checklists_org ON public.workflow_checklists USING btree (org_id);
CREATE INDEX IF NOT EXISTS idx_workflow_checklists_standard ON public.workflow_checklists USING btree (technical_standard);
CREATE INDEX IF NOT EXISTS idx_workflow_checklists_step ON public.workflow_checklists USING btree (workflow_step_id);
CREATE INDEX IF NOT EXISTS idx_workflow_checklists_step_component ON public.workflow_checklists USING btree (step_key, component, is_mandatory, is_active) WHERE ((is_mandatory = true) AND (is_active = true));
...
CREATE INDEX IF NOT EXISTS idx_workflow_status_history_date ON public.workflow_status_history USING btree (changed_at);
CREATE INDEX IF NOT EXISTS idx_workflow_status_history_order ON public.workflow_status_history USING btree (order_workflow_id);
CREATE INDEX IF NOT EXISTS idx_workflow_status_history_user ON public.workflow_status_history USING btree (changed_by);
...
CREATE INDEX IF NOT EXISTS idx_workflow_steps_component ON public.workflow_steps USING btree (component);
CREATE INDEX IF NOT EXISTS idx_workflow_steps_engine_type ON public.workflow_steps USING btree (engine_type_id);
