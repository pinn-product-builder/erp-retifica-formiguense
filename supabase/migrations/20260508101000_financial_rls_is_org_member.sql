-- Alinha RLS do financeiro a is_org_member(org_id) para permitir consultas .in('org_id', ...)
-- no mesmo request quando o usuário é membro de várias organizations (visão consolidada).
