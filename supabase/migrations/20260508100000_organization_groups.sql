...
-- Tenant operacional continua sendo organizations; org_id nas linhas financeiras não muda.
...
-- IDs de organizations no mesmo grupo que p_org (vazio se a org não está em grupo)
